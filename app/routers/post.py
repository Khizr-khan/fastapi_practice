...
def get_posts(db: Session = Depends(get_db), current_user: int = Depends(oauth2.get_current_user)
    ...
    # response = [{"Post": post[0], "votes": post[1]} for post in results]
...
def get_post(id: int, db:Session = Depends(get_db), current_user: int = Depends(oauth2.get_current_user)):
    ...
    # print('post: ',results[0].id)
    # print('title: ',results[0].title)
    # print('content: ',results[0].content)
    # print('published: ',results[0].published)
    # print('created_at: ',results[0].created_at)
    # print('owner_id: ',results[0].owner_id)
